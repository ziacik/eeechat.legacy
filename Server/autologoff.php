<?php
    ...
    {
    	$query = "UPDATE eee_User SET Access = Now(), State=2 WHERE UserID=$user->UserID";
	    mysql_query($query) or die("Query failed");

	    $query = "INSERT INTO eee_Message(FromUserID, ToUserID, Message, Time, Seen) VALUES($user->UserID, 0, '[STATE $user->Name;2;Inactive]', Now(), 0)";
	    mysql_query($query) or die("Query failed");
	}
