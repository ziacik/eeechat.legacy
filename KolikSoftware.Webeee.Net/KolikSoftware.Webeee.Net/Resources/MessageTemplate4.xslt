            ...
            <xsl:for-each select="eee:Message">
                <message messageId="{eee:MessageID}">
                    <div style="font-family:Lucida Sans; font-size:10px; padding-top: 5px; padding-bottom: 15px;">
                        <div class="GradientWhite" style="color:#F0F0F0; height: 10px; float:left; border: 1px #{eee:ColorHex} solid; background-color: #{eee:ColorHex}; padding: 1px 4px 1px 4px;">
                            <span class="GradientWhiteImg blabla">
                            </span>
                            <xsl:choose>
