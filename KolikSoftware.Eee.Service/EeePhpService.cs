...
namespace KolikSoftware.Eee.Service
{
    ...
    {
        protected string phpServiceAddress;
        ...
        {
            this.phpServiceAddress = phpServiceAddress;
            ...
            if (this.phpServiceAddress.EndsWith("/") == false)
                this.phpServiceAddress = this.phpServiceAddress + "/";
        }
        ...
        protected EeeDataSet InvokeToDataSet(string page, params object[] paramsAndValues)
        {
        ...
        protected string InvokeAny(bool invokeLong, string page, string openTag, string closeTag, object[] paramsAndValues)
        {
            ...
            if (page.StartsWith("http://"))
                ...
                uri = new Uri(this.phpServiceAddress + page);
            ...
            using (response = request.GetResponse())
            {
                ...
                using (Stream stream = response.GetResponseStream())
                {
                    using (StreamReader reader = new StreamReader(stream))
                    {
                        ...
                        return text.Substring(startIdx, endIdx - startIdx + closeTag.Length);
                    }
                }
            }
        }
        ...
        public bool AddMessage(int roomId, string recipientLogin, string message, string externalFrom)
        {
        ...
        public string UploadFile(string filePath, object parameter)
        {
            ...
            return this.phpServiceAddress + "Upload/" +fileId;
        }
        ...
        bool UploadFile(string fileId, string filePath)
        {
            using (WebClient client = new WebClient())
            {
                ...
                byte[] responseBytes = client.UploadFile(this.phpServiceAddress + "upload.php", "POST", filePath);
